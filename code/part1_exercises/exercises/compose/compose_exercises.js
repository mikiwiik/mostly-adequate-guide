...
var sanitizeNames = map( // Process an array
    _.compose( // Process single entry
        toLowerCase,
        _underscore,
        _.prop('name')
    )
...
fastestCar = _.compose(
    _.flip(_.concat)(' is the fastest'), // Flipping the params to concat => Append the given string
    _.prop('name'),
    _.last,
    _.sortBy(
        _.prop('horsepower')
